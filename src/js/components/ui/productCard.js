...
export function renderProductCard(product) {
  ...
  return `
    <div class="product-card relative bg-surface-0 rounded-2xl shadow-sm hover:shadow-lg transition-all border border-surface-100 overflow-hidden group animate-fadeIn" itemscope itemtype="https://schema.org/Product">
