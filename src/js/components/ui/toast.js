export function showToast(message, type='info') {
  ...
  toast.className = `animate-toastIn flex items-center gap-3 ${colors[type]}/90 backdrop-blur-md text-white px-4 py-3 rounded-xl shadow-lg border border-white/10 max-w-sm`;
