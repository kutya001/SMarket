    ...
    <div class="max-w-[1500px] w-full mx-auto px-2 sm:px-4 pb-12">
      ...
      <div id="offersBlock" class="ui-island mb-10 !p-4 sm:!p-8">
        ...
        <div class="relative w-full h-64 md:h-80 mb-6">
          <div id="offersMap" class="ui-island-element ui-border-v w-full h-full !bg-surface-0 !p-1 overflow-hidden z-10"></div>
          <button onclick="window.navigate('/map')" class="absolute top-3 right-3 z-[400] bg-surface-0/90 backdrop-blur-md px-3 py-1.5 rounded-xl shadow-lg hover:shadow-xl border border-surface-200 text-[10px] font-bold text-surface-700 hover:text-primary-600 transition-all flex items-center gap-1">
